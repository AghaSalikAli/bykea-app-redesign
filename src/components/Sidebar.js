    ...
    const icons = {
      ...
      history: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M3.05 11C3.51301 7.60771 5.69495 4.7277 8.83963 3.46927C11.9843 2.21084 15.5537 2.76508 18.1692 4.94506C20.7847 7.12504 21.9992 10.5731 21.3779 13.9707C20.7566 17.3683 18.3926 20.1397 15.1 21.28" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M3 16L3.35 12L7.35 12.35" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      ),
      wallet: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
